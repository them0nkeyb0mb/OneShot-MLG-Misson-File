...
switch (_side) do
{
	case west:
	{
		_return = [
			...
			["cop_spawn_train","Training Area","\a3\ui_f\data\map\GroupIcons\badge_rotate_0_gs.paa"]
		];
	};
	...
	case civilian:
	{
		...
		{
			_return pushBack["PMC_Base","PMC Base","\a3\ui_f\data\map\MapControl\watertower_ca.paa"];
		};
