...
switch (_vehicle) do
{
	...
	case "C_Van_01_box_F":
	{
		...
		[
			...
			["textures\med\Ambulance_Boxer_Front.paa","med","textures\med\Ambulance_Boxer_Back.paa"]
		];
	};
	...
	case "O_Heli_Light_02_unarmed_F":
	{
		...
		[
			...
			["textures\med\paramedic_hems.paa","med"]
		];
	};
	...
	case "C_Heli_Light_01_civil_F":
	{
		...
		[
			...
			["\a3\air_f\Heli_Light_01\Data\Skins\heli_light_01_ext_wave_co.paa","civ"],
			["\a3\air_f\Heli_Light_01\Data\Skins\heli_light_01_ext_digital_co.paa","reb"],
			["textures\med\medic_Lit.jpg","med"]
		];
	};
	...
	case "B_MRAP_01_F":
	{
		_ret = 
		[
			["textures\cop\met_police_hunter_front.paa","cop","textures\cop\met_police_hunter_back.paa"],
	...
	case "O_Truck_02_covered_F":
	{
		_ret = 
		[
			["textures\cop\met_police_zamac_cab.paa","cop","textures\cop\met_police_zamac_back.paa"]
		];
	};
	...
	case "I_Heli_light_03_unarmed_F":
	{
		_ret = 
		[
			["textures\cop\police_india99.paa","cop"]
		];
	};
